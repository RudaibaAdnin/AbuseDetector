...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        Chartist.Pie('#chartPreferences', {
            labels: ['Unabused', 'Toxic', 'Severe' , 'Insult' , 'Threat' ,'Obscene' , 'Hate'],
            series: [75, 30, 40 , 50, 40, 40 , 40]
        });
...
$().ready(function() {
	   ...
	   // var username=a[1];
		...
		document.getElementById("blockpage").innerHTML+='<a class="nav-link" href="/options/blocked_list.html?'+
		username+'\">'+'<i class="nc-icon nc-tap-01"></i><p>Block List</p></a>';
